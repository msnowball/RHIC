#ifndef PHG3toG4MuonRPCHit_h
#define PHG3toG4MuonRPCHit_h 1
...
class PHG3toG4MuonRPCHit : public G4VHit
{
public:
    PHG3toG4MuonRPCHit();
    PHG3toG4MuonRPCHit(const PHG3toG4MuonRPCHit &right);
    virtual ~PHG3toG4MuonRPCHit();

    const PHG3toG4MuonRPCHit& operator=(const PHG3toG4MuonRPCHit &right);
    const PHG3toG4MuonRPCHit& operator+=(const PHG3toG4MuonRPCHit &right);
    int operator==(const PHG3toG4MuonRPCHit &right) const;

    G4bool isTheSameHit(PHG3toG4MuonRPCHit *right);
...
typedef G4THitsCollection<PHG3toG4MuonRPCHit> PHG3toG4MuonRPCHitsCollection;

extern G4ThreadLocal G4Allocator<PHG3toG4MuonRPCHit>* PHG3toG4MuonRPCHitAllocator;
