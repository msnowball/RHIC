#ifndef PHG3toG4MuonIDHit_h
#define PHG3toG4MuonIDHit_h 1
...
class PHG3toG4MuonIDHit : public G4VHit
{
public:
    PHG3toG4MuonIDHit();
    PHG3toG4MuonIDHit(const PHG3toG4MuonIDHit &right);
    virtual ~PHG3toG4MuonIDHit();

    const PHG3toG4MuonIDHit& operator=(const PHG3toG4MuonIDHit &right);
    const PHG3toG4MuonIDHit& operator+=(const PHG3toG4MuonIDHit &right);
    int operator==(const PHG3toG4MuonIDHit &right) const;

    G4bool isTheSameHit(PHG3toG4MuonIDHit *right);
...
typedef G4THitsCollection<PHG3toG4MuonIDHit> PHG3toG4MuonIDHitsCollection;

extern G4ThreadLocal G4Allocator<PHG3toG4MuonIDHit>* PHG3toG4MuonIDHitAllocator;
