...
G4ThreadLocal G4Allocator<PHG3toG4MuonRPCHit>* PHG3toG4MuonRPCHitAllocator;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

PHG3toG4MuonRPCHit::PHG3toG4MuonRPCHit():
  G4VHit(), 
  fParticleID(0),
  fTrackID(-1),
  fLayerID(-1), 
...
PHG3toG4MuonRPCHit::PHG3toG4MuonRPCHit(const PHG3toG4MuonRPCHit &right):
  G4VHit() 
{
...
const PHG3toG4MuonRPCHit& PHG3toG4MuonRPCHit::operator=(const PHG3toG4MuonRPCHit &right)
{
  fParticleID = right.fParticleID;
  fTrackID = right.fTrackID;
  fLayerID = right.fLayerID;
...
int PHG3toG4MuonRPCHit::operator==(const PHG3toG4MuonRPCHit &right) const
{
...
const std::map<G4String,G4AttDef>* PHG3toG4MuonRPCHit::GetAttDefs() const
{
    G4bool isNew;
    std::map<G4String,G4AttDef>* store
      = G4AttDefStore::GetInstance("PHG3toG4MuonRPCHit",isNew);
...
std::vector<G4AttValue>* PHG3toG4MuonRPCHit::CreateAttValues() const
{
    std::vector<G4AttValue>* values = new std::vector<G4AttValue>;
    
    values
      ->push_back(G4AttValue("HitType","MuonRPCHit",""));
    values
...
G4bool PHG3toG4MuonRPCHit::isTheSameHit(PHG3toG4MuonRPCHit *right)
{
...
void* PHG3toG4MuonRPCHit::operator new(size_t)
{
    if (!PHG3toG4MuonRPCHitAllocator)
        PHG3toG4MuonRPCHitAllocator = new G4Allocator<PHG3toG4MuonRPCHit>;
    return (void*)PHG3toG4MuonRPCHitAllocator->MallocSingle();
}

void PHG3toG4MuonRPCHit::operator delete(void* aHit)
{
    PHG3toG4MuonRPCHitAllocator->FreeSingle((PHG3toG4MuonRPCHit*) aHit);
}
