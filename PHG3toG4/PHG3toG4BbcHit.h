#ifndef PHG3toG4BbcHit_h
#define PHG3toG4BbcHit_h 1
...
class PHG3toG4BbcHit : public G4VHit
{
public:
    PHG3toG4BbcHit();
    PHG3toG4BbcHit(const PHG3toG4BbcHit &right);
    virtual ~PHG3toG4BbcHit();

    const PHG3toG4BbcHit& operator=(const PHG3toG4BbcHit &right);
    const PHG3toG4BbcHit& operator+=(const PHG3toG4BbcHit &right);
    int operator==(const PHG3toG4BbcHit &right) const;

    G4bool isTheSameHit(PHG3toG4BbcHit *right);
    ...
    void AddStepLength(G4double l) { fStepLength += l; }
...
typedef G4THitsCollection<PHG3toG4BbcHit> PHG3toG4BbcHitsCollection;

extern G4ThreadLocal G4Allocator<PHG3toG4BbcHit>* PHG3toG4BbcHitAllocator;
