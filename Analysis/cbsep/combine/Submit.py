...
def parseOptions():
  ...
  parser.add_option('--combine',action='store_true', dest='SUBMIT_COMBINE', default=True ,help='hadd files')
  parser.add_option('-n', '--nFiles', dest='FILES_PER_JOB', type='int', default=20 ,help='N Files Per Job (def:20)')
