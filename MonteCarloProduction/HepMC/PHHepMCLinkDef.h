...
//#pragma link C++ class HepMC::GenParticleComparison+;
//#pragma link C++ class std::set<HepMC::GenParticle*,HepMC::GenParticleComparison>+;
...
#pragma link C++ class PHHepMCHelper-!;
